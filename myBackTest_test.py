...
if __name__ == "__main__":
    ...
    hold_result_df = back_test(k_num,given_codes=holds,except_stocks=['002807','603515'],type='hold',source=source_type)#except_stocks)
    addition_name = 'hold'
    ...
    for rate in [0.01,0,-0.005,-0.01]: #[0.015,0.01,0.007,0.003,0.03,0.02,0.00001]
        try:
            ...
            continue
    #all_result_df = back_test(k_num,given_codes=[],except_stocks=[],type='stock',source=source_type,rate_to_confirm=0.08)#except_stocks)
